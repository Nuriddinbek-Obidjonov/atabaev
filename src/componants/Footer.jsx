    ...
    <div className='bg-orange-300 py-20'>
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
                ...
                <div>
                    <h2 className='mt-10 sm:mt-0 mb-5 text-2xl font-semibold'>{t('footer.card2.title')}</h2>
                ...
                <div>
                    <h2 className='mt-10 md:mt-0 mb-5 text-2xl font-semibold'>{t('footer.card3.title')}</h2>
